...
* The warning about a status that can't be found now leads with how to fix it and states the likely cause, instead of trailing off into "see X for more details".
